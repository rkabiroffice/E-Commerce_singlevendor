    ...
    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
        <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
            ...
            @if ($user)
                ...
                @if ($user->phone != null)
                    <div class="text-truncate opacity-60">{{ $user->phone }}</div>
                @else
                    <div class="text-truncate opacity-60">{{ $user->email }}</div>
                @endif
            @else
                <h4 class="h5 fs-16 mb-1 fw-600">Guest</h4>
                <div class="text-truncate opacity-60">Please login</div>
            @endif
        </div>
