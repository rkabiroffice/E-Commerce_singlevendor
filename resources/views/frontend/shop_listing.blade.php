                    ...
                    @if($shop->user !=null)
                        <div class="col">
                            <div class="row no-gutters bg-white align-items-center border border-light rounded hov-shadow-md mb-3 has-transition">
                                <div class="col-4">
                                    <a href="{{ url('/shop/' . $shop->slug) }}" class="d-block p-3" tabindex="0">
                                        <img
                                ...
                                <div class="col-8 border-left border-light">
                                    <div class="p-3 text-left">
                                        <h2 class="h6 fw-600 text-truncate">
                                            <a href="{{ url('/shop/' . $shop->slug) }}" class="text-reset" tabindex="0">{{ $shop->name }}</a>
                                        </h2>
                                        <div class="rating rating-sm mb-2">
                                            {{ renderStarRating($shop->rating) }}
                                        </div>
                                        <a href="{{ url('/shop/' . $shop->slug) }}" class="btn btn-soft-primary btn-sm" tabindex="0">
