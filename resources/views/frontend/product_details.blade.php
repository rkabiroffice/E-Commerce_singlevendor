                        ...
                        <div class="text-left">
                            ...
                            @if ($detailedProduct->wholesale_product)
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        @foreach (optional($detailedProduct->stocks->first())->wholesalePrices ?? [] as $wholesalePrice)
                                            <tr>
                            ...
                            @if (addon_is_activated('refund_request'))
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <a href="{{ url('/return-policy') }}" class="ml-2"
                    ...
                    @if ($detailedProduct->added_by == 'seller' && optional($detailedProduct->user)->shop != null)
                        <div class="bg-white shadow-sm mb-3">
                            <div class="position-relative p-3 text-left">
                                ...
                                <a href="{{ url('/shop/' . $detailedProduct->user->shop->slug) }}"
        ...
        as $key => $top_product)
                                    <li class="py-3 px-0 list-group-item border-light">
                                        <div class="row gutters-10 align-items-center">
                                            <div class="col-5">
                                                <a href="{{ url('/product/' . $top_product->slug) }}"
                        ...
                        <div class="bg-white rounded shadow-sm mt-3">
                            ...
                            @guest
                                <p class="fs-14 fw-400 mb-0 ml-3 mt-2"><a
                                        href="{{ url('/users/login') }}">{{ translate('Login') }}</a> or <a class="mr-1"
                                        href="{{ url('/users/registration') }}">{{ translate('Register ') }}</a>{{ translate(' to submit your questions to seller') }}
                                </p>
                            @endguest
                            @auth
                                <div class="query form p-3">
                                    ...
                                    @endif
                                    <form action="{{ url('/product-queries') }}" method="POST">
                                        @csrf
    ...
    <div class="modal fade" id="chat_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                ...
                <form class="" action="{{ url('/conversations') }}" method="POST"
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="8" name="message" required
                                placeholder="{{ translate('Your Question') }}">{{ url('/product/' . $detailedProduct->slug) }}</textarea>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-zoom" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ url('/users/login/cart') }}"
                            method="POST">
                            @csrf
                            <div class="form-group">
