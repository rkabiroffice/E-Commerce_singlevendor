...
@section('content')
    ...
    <section class="mb-4">
        <div class="container text-left">
            <div class="row">
                <div class="col-lg-8">
                    <form action="{{ url('/checkout/payment') }}" class="form-default" role="form" method="POST"
                        id="checkout-form">
                        @csrf
                        ...
                        <div class="pt-3">
                            ...
                            <a href="{{ url('/terms') }}">{{ translate('terms and conditions') }}</a>,
                            <a href="{{ url('/return-policy') }}">{{ translate('return policy') }}</a> &
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "#coupon-remove", function() {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('/checkout/remove_coupon_code') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
