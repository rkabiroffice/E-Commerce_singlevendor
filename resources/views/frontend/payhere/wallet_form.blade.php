    ...
    <form style="display: none" method="POST" action="{{ \App\Utility\PayhereUtility::get_action_url() }}" id="payhere-wallet-form">
        ...
        <input type="hidden" name="return_url" value="{{ url('/payhere/wallet/return') }}">
        <input type="hidden" name="cancel_url" value="{{ url('/payhere/wallet/cancel') }}">
        <input type="hidden" name="notify_url" value="{{ url('/payhere/wallet/notify') }}">
