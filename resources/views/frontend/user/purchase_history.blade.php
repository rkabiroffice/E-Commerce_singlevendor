                    ...
                    <tbody>
                        @foreach ($orders as $key => $order)
                            @if (count($order->orderDetails) > 0)
                                <tr>
                                    <td>
                                        <a href="{{ url('/purchase_history/details/' . encrypt($order->id)) }}">{{ $order->code }}</a>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        @endif
                                        <a href="{{ url('/purchase_history/details/' . encrypt($order->id)) }}" class="btn btn-soft-info btn-icon btn-circle btn-sm" title="{{ translate('Order Details') }}">
