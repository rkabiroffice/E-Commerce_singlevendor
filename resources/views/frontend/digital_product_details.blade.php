...
@section('meta')
    ...
    <meta property="og:url" content="{{ url('/product/' . $detailedProduct->slug) }}" />
                        ...
                        <div class="text-left">
                            ...
                            @if (addon_is_activated('refund_request'))
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        <a href="{{ url('/return-policy') }}" target="_blank">
                                            @if ($refund_sticker != null)
                                                <img src="{{ uploaded_asset($refund_sticker) }}" height="36">
                                            @else
                                                <img src="{{ static_asset('assets/img/refund-sticker.jpg') }}" height="36">
                                            @endif</a>
                                        <a href="{{ url('/return-policy') }}" class="ml-2" target="_blank">{{ translate('View Policy') }}</a>
                                    </div>
                                </div>
                            @endif
                    ...
                    @if ($detailedProduct->added_by == 'seller' && optional($detailedProduct->user)->shop != null)
                        <div class="bg-white shadow-sm mb-3">
                            <div class="position-relative p-3 text-left">
                                ...
                                <a href="{{ url('/shop/' . $detailedProduct->user->shop->slug) }}" class="text-reset d-block fw-600">
                            ...
                            <div class="row no-gutters align-items-center border-top">
                                <div class="col">
                                    <a href="{{ url('/shop/' . $detailedProduct->user->shop->slug) }}" class="d-block btn btn-soft-primary rounded-0">{{ translate('Visit Store')}}</a>
                                </div>
                                <div class="col">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="py-3 px-0 list-group-item border-light">
                                    <div class="row gutters-10 align-items-center">
                                        <div class="col-5">
                                            <a href="{{ url('/product/' . $top_product->slug) }}" class="d-block text-reset">
                                                <img
                                        ...
                                        <div class="col-7">
                                            <h4 class="fs-13 text-truncate-2">
                                                <a href="{{ url('/product/' . $top_product->slug) }}" class="d-block text-reset">{{ $top_product->getTranslation('name') }}</a>
                                            </h4>
                                    ...
                                    @if(Auth::check())
                                        ...
                                        @if ($commentable)
                                            <div class="pt-4">
                                                ...
                                                <form class="form-default" role="form" action="{{ url('/reviews') }}" method="POST">
                                                    @csrf
                            ...
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                                ...
                                <div class="carousel-box">
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        <div class="">
                                            <a href="{{ url('/product/' . $related_product->slug) }}" class="d-block">
                                                <img
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            ...
                                            <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                                <a href="{{ url('/product/' . $related_product->slug) }}" class="d-block text-reset">{{ $related_product->getTranslation('name') }}</a>
                                            </h3>
    ...
    <div class="modal fade" id="chat_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                ...
                <form class="" action="{{ url('/conversations') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="product_id" value="{{ $detailedProduct->id }}">
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="8" name="message" required placeholder="{{ translate('Your Question') }}">{{ url('/product/' . $detailedProduct->slug) }}</textarea>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-zoom" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ url('/users/login/cart') }}" method="POST">
                            @csrf
                            <div class="form-group">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-6 text-right">
                                    <a href="{{ url('/password/reset') }}" class="text-reset opacity-60 fs-14">{{ translate('Forgot password?')}}</a>
                                </div>
                            </div>
                        ...
                        <div class="text-center mb-3">
                            ...
                            <a href="{{ url('/users/registration') }}">{{ translate('Register Now')}}</a>
                        </div>
                        @if(get_setting('google_login') == 1 ||
                            ...
                            <ul class="list-inline social colored text-center mb-5">
                                @if (get_setting('facebook_login') == 1)
                                    <li class="list-inline-item">
                                        <a href="{{ url('/social-login/facebook') }}" class="facebook">
                                ...
                                @if(get_setting('google_login') == 1)
                                    <li class="list-inline-item">
                                        <a href="{{ url('/social-login/google') }}" class="google">
                                ...
                                @if (get_setting('twitter_login') == 1)
                                    <li class="list-inline-item">
                                        <a href="{{ url('/social-login/twitter') }}" class="twitter">
                                ...
                                @if (get_setting('apple_login') == 1)
                                    <li class="list-inline-item">
                                        <a href="{{ url('/social-login/apple') }}" class="apple">
