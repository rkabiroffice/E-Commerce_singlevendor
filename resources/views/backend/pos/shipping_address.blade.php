            ...
            <span class="d-flex p-3 pad-all aiz-megabox-elem">
                ...
                <span class="flex-grow-1 pl-3 pad-lft">
                    ...
                    <div>
                        ...
                        <span class="strong-600 ml-2">{{ $address->city ? $address->city->name : '' }}</span>
                    </div>
                    <div>
                        <span class="alpha-6">{{ translate('State') }}:</span>
                        <span class="strong-600 ml-2">{{ $address->state ? $address->state->name : '' }}</span>
                    </div>
                    <div>
                        <span class="alpha-6">{{ translate('Country') }}:</span>
                        <span class="strong-600 ml-2">{{ $address->country ? $address->country->name : '' }}</span>
                    </div>
                    <div>
